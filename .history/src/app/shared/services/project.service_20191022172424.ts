...
export class ProjectService {
  ...
  public alumniListItems: any[] = [];
  public undergraduateListItems: any[] = [];
  public postgraduateListItems: any[] = [];
  public staffListItems: any[] = [];
  public validAlumniListItems: any[] = [];
  public validUndergraduateListItems: any[] = [];
  public validPostgraduateListItems: any[] = [];
  public validStaffListItems: any[] = [];
  public validDataListItems: any[] = [];
  public approvedDataListItems: any[] = [];
  public uploadedDataListItems: any[] = [];
  public selectedIndividual: any = {};
  public totalUsersCount: number = 0;
  public alumniCount: number = 0;
  public undergraduateCount: number = 0;
  public postgraduateCount: number = 0;
  public staffCount: number = 0;
  public countList: number[];
  public branchListItems: any[];

  public userListItems: any[] = [];
  public userGroupListItems: any[] = [];
  public deviceListItems: any[] = [];
  public doorListItems: any[] = [];
  public accessLevelListItems: any[] = [];
  // biostar
  public biostarUsersInDeviceItems: any[];
  public biostarAccessLevels: any[];
  public biostarAccessGroups: any[];
  public biostarScheduleListItems: any[];
  public allBiostarDeviceItems: any[];
  public allBiostarUsers: any[];
  ...
  getBiostarUsersInDeviceData(devID) { return this.http.post<any>(`${this.apiUrl}vault/usfdv/`, { dev_id: devID, limit: 1000, offset: 0 }); }
  ...
  getTotalUsersCount() {
    this.http.post<any[]>(`${this.apiUrl}vault/total/users/`, {}).subscribe(
      async (data) => {
  ...
  getPostgraduateCount() {
    this.http.post<any[]>(`${this.apiUrl}vault/pgcount/`, {}).subscribe(
  ...
  getUndergraduateCount() {
    this.http.post<any[]>(`${this.apiUrl}vault/ugcount/`, {}).subscribe(
  ...
  addOneUserToDevice(registerInfo, user) {
    ...
    return this.http.post<any>(`${this.apiUrl}vault/adout/`, postInfo).subscribe((res) => {
